...
app.post('/foods/add', function (req, res) {
    ...
    req.checkBody('category','Category in Food Pyramid is Required').notEmpty()
    ...
    req.checkBody('calories', 'Calories per Serving Size is Required').notEmpty()
    req.checkBody('meal', 'Meal Selection is Required').notEmpty()
